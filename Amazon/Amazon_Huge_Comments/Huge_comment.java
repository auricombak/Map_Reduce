...
public class Huge_comment {
	private static final String INPUT_PATH = "input-amazon/";
	private static final String OUTPUT_PATH = "output/HugeComment/Comments-";
	private static final Logger LOG = Logger.getLogger(Huge_comment.class.getName());
