...
public class Amazon_Unhappy_Reviewer {
	private static final String INPUT_PATH = "input-amazon/";
	private static final String OUTPUT_PATH = "output/UnhappyAuth/Unhappy-";
	private static final Logger LOG = Logger.getLogger(Amazon_Unhappy_Reviewer.class.getName());
