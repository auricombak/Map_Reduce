...
public class Amazon_Best_Reviewer {
	private static final String INPUT_PATH = "input-amazon/";
	private static final String OUTPUT_PATH = "output/BestReviewer/Best-";
	private static final Logger LOG = Logger.getLogger(Amazon_Best_Reviewer.class.getName());
